...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # FIXME Note that the dataloader should be returning a dictionary with `seg` and `image` keys...
            # DONE we're missing another piece: check the SlicesDatset module. 
            
            # FIXME Seeing some issues with the shape of these being unequal, as well as datatypes
            # DONE all _should_ now be addressed in the SlicesDataset module
            ...
            # ANSWER:
            # Batch number
            # Class probability -- TODO confirm after review of additional tensor operations.
            # y pixel coordinates
            # z pixel coordinates
    ...
    def run_test(self):
        ...
        for i, x in enumerate(self.test_data):
            ...
            # TODO remove this: seeing some issues with NoneType. Where is this coming from?
